	...
	return (
		...
		>
			...
			<motion.p
				...
				className="mt-1 text-center  max-w-48 md:max-w-xl lg:max-w-2xl text-lg md:text-2xl   leading-tight"
			>
				{subtitle}
			</motion.p>
			...
			>
				...
				<a className="rounded-full border   text-blue-500 hover:bg-blue-600 hover:text-white transition px-3 md:px-6 py-1 md:py-2 text-md md:text-lg">
					{buttonRightText}
				</a>
			</motion.div>
			...
			<motion.div
				...
				className=" mt-10 md:mt-8 w-full  h-77 md:h-150   mx-auto relative overflow-hidden"
			>
				<Image
					src={imageDesktop}
					alt="iPhone"
